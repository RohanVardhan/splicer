...
sys.path.append(r'C:\Users\LZM100.00014\splicer_comm\32b')
import clr# as clr
...
class HelloWorldForm(Form):
    ...
    def __init__(self):
        ...
        a = clr.UsbFsm100ServerClass( self.Handle )

        a.Attached += self.my_handler
        a.Detached += self.my_handler

        a.InitDriver(self.Handle)
